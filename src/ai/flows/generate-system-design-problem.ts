...
// import { supportedModels } from '@/lib/models'; // Import from new location - REMOVED
...
const GenerateSystemDesignProblemInputSchema = z.object({
  ...
  modelName: z.string().min(1, "AI Model name must be provided") // Validate as non-empty string
